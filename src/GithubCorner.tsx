/**
 * Adapted for React from https://tholman.com/github-corners/
 * 
 * @param props
 * @param props.href {string} Where to link to
 * @returns 
 */
const GithubCorner = ({
  href
